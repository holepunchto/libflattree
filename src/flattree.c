...
extern uint64_t flat_tree_iterator_index (flat_tree_iterator_t *it);
extern uint64_t flat_tree_iterator_depth (flat_tree_iterator_t *it);
extern uint64_t flat_tree_iterator_offset (flat_tree_iterator_t *it);
