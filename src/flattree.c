...
extern int flat_tree_iterator_is_left (flat_tree_iterator_t *it);
extern int flat_tree_iterator_is_right (flat_tree_iterator_t *it);
...
extern void flat_tree_iterator_next (flat_tree_iterator_t *it);
extern void flat_tree_iterator_prev (flat_tree_iterator_t *it);
extern void flat_tree_iterator_next_tree (flat_tree_iterator_t *it);
extern void flat_tree_iterator_prev_tree (flat_tree_iterator_t *it);
extern int flat_tree_iterator_contains (flat_tree_iterator_t *it, uint64_t index);
...
extern void flat_tree_iterator_left_span (flat_tree_iterator_t *it);
extern void flat_tree_iterator_right_span (flat_tree_iterator_t *it);
extern int flat_tree_iterator_full_root (flat_tree_iterator_t *it, uint64_t index);
extern int flat_tree_iterator_is_root (flat_tree_iterator_t *it, uint64_t length);
